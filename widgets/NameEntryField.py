...
class NameEntryField(CustomEntryField):
# Efectua validacion de solo Caracteres Alfabeticos

    def __init__(self, str1=None, str2=None, int1=50, int2=None):
        CustomEntryField.__init__(self)
        self.letterKeys=('a','A','b','B','c','C','d','D','e','E','f','F','g','G','h','H','i','I','j','J','k','K','l','L','m','M','n','N','o','O','p','P','q','Q','r','R','s','S','t','T','u','U','v','V','w','W','x','X','y','Y','z','Z','space','1','2','3','4','5','6','7','8','9','0','.')
...
##        widget.create_pango_context(widget.get_text().upper())

...
# Effettua la validazione per decimali senza segno
    ...
    def __init__(self, str1="0.00", str2=None, int1=8, int2=2):
        ...
        if self._lunghezza > 0:
            self.set_max_length(self._lunghezza + self._precisione)
            self.set_width_chars(self._lunghezza+ self._precisione)
